...
export default function HomePage() {
  ...
  return (
    <RecaptchaGate storageKey="recaptcha_verified_homepage">
            ...
            {[
              {
                ...
                testimonial: "تجربة رائعة مع الأستاذ عبدالرحمن، شرح مميز وطريقة سهلة في توصيل المعلومة"
              },
              {
                name: "سيف طارق",
